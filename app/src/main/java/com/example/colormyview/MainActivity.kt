...
//    }
    ...
    private fun setListeners(){
        ...
        val clickableViews:List<View> =
            ...
            listOf<View>(binding.boxOneText,binding.boxTwoText,binding.boxThreeText,binding.boxFourText,binding.boxFiveText,binding.redButton,binding.yellowButton,binding.greenButton )
